...
```
npm create cloudflare@latest -- --template=cloudflare/templates/patient-rice-d06c
```

A live public deployment of this template is available at [https://patient-rice-d06c.templates.workers.dev](https://patient-rice-d06c.templates.workers.dev)
